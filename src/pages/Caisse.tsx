...
import { Camera, Scan, Plus, Minus, ShoppingCart, Printer, Trash2 } from "lucide-react";
...
export default function Caisse() {
  ...
  const validateSale = async () => {
    ...
    try {
      ...
      toast({
        title: "✅ Vente validée",
        description: "Stock mis à jour et reçu généré",
      });
    } catch (error) {
      toast({
        title: "Erreur",
  ...
  return (
    <div className="space-y-4 p-4 md:p-6 max-w-7xl mx-auto">
      {/* En-tête */}
      <div className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-950/20 dark:to-blue-900/10 border-2 border-blue-200 dark:border-blue-800/40 rounded-lg p-4 md:p-6">
        <h2 className="text-2xl md:text-3xl font-bold text-blue-900 dark:text-blue-100 text-center">
          🛒 Caisse Tactile
        </h2>
        <p className="text-blue-700 dark:text-blue-300 text-center mt-2">
      ...
      {showReceipt && (
        <Card className="max-w-md mx-auto">
          <CardHeader>
            <CardTitle className="text-center">🧾 Reçu de vente</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="border-t border-b py-3">
              <h3 className="text-center font-bold">SIGR SUPERMARCHÉ</h3>
